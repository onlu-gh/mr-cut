...
import PhoneNumberField, {toNationalPhoneNumber} from '@/components/PhoneNumberField';
...
export default function Login() {
   ...
   // National significant number (no `+972`, no trunk 0); the OTP API prepends the
   // country code.
   const constructPhoneNumber = () => toNationalPhoneNumber(phoneNumber);
